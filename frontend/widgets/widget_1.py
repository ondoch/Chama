...
class EmployeePersonalInfo(QFrame):
    ...
    def initUI(self):
        ...
        self.phone_number = FormInput("resources/phone.svg", "Phone Number")
        self.employee_id = GenerateFormInput("resources/emp.svg", "Employment Number")
        self.employment_date = FormInput("resources/calender.svg", "Employment Date")

        column_1.addWidget(self.first_name)
        column_1.addWidget(self.email_address)
        column_1.addWidget(self.national_id)
        column_1.addWidget(self.job_title)

        column_2.addWidget(self.last_name)
        column_2.addWidget(self.phone_number)
        column_2.addWidget(self.employee_id)
        column_2.addWidget(self.employment_date)
