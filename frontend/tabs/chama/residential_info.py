...
class ResidentialInfo(QFrame):
    ...
    def initUI(self):
        ...
        header = QLabel("Residential Information")
        ...
        self.country = MemberFormInput("Country of residence")
        self.county = MemberFormInput("County of residence")
        self.town = MemberFormInput("Town/City of residence")
        self.estate = MemberFormInput("Estate/Address")

        self.physical_address = MemberFormInput("Physical Address")
        self.postal_address = MemberFormInput("Postal Address")
        self.postal_code = MemberFormInput("Postal Code")

        grid.addWidget(self.country, 0, 0)
        grid.addWidget(self.county, 1, 0)
        grid.addWidget(self.town, 2, 0)
        grid.addWidget(self.estate, 3, 0)

        grid.addWidget(self.physical_address, 0, 1)
        grid.addWidget(self.postal_address, 1, 1)
        grid.addWidget(self.postal_code, 2, 1)
